    ...
    <div className="min-h-screen bg-gray-100 flex items-start justify-center py-8 px-4">
      <div className="w-full max-w-lg bg-white rounded-2xl shadow-sm p-6">
        ...
        <div className="border border-gray-300 rounded-lg px-4 py-3 mb-5 flex justify-between items-start">
          <div>
            <p className="text-sm text-gray-700">Home: 123 Main Street, Victoria Island, Lagos</p>
        ...
        {/* Delivery Time */}
        <div className="mb-5">
          <p className="text-sm font-semibold text-gray-900 mb-2">Delivery Time</p>
        ...
        <div className="mb-5">
          <p className="text-sm font-semibold text-gray-900 mb-2">Delivery Instructions (Optional)</p>
          <textarea
            rows={4}
        ...
        {/* Contact Address */}
        <div className="mb-2">
          <p className="text-sm font-semibold text-gray-900 mb-2">Contact Address</p>
          <input
            type="text"
